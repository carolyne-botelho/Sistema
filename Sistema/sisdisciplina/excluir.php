...
<div class="box">
      ...
      <form method="post" action="excluir.php">
        ...
        <input type="text" id="nome" name="nome" placeholder="Digite o nome da disciplina para confirmar" required> <br>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conexao->prepare("DELETE FROM Disciplina WHERE nome = :nome");
