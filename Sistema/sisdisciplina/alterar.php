...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conexao->prepare("UPDATE Disciplina SET nome = :nome, ch = :ch, semestre = :semestre, idprofessor = :idprofessor  WHERE id = :id");
...
<div class="box">
    <h1>Alterar Disciplina</h1>
      <form method="post">
            ...
            <p>Nome: <br> <input type="text" placeholder="Digite o nome da disciplina" name="nome" maxlength= "100" required value="<?php echo $disciplina['nome']; ?>"></p>
