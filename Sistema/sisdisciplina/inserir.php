...
<body>
    <div class="box">
        ...
        <form method="post" action="inserir.php">
            <p>Nome: <br> <input type="text" placeholder="Digite o nome da disciplina" name="nome" maxlength= "100" required></p>
...
if (isset($_POST['nome'])) {
    ...
    $stmt = $conexao->prepare("INSERT INTO Disciplina (nome, ch, semestre, idprofessor) VALUES (:nome, :ch, :semestre, :idprofessor)");
