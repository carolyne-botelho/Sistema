...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conexao->prepare("UPDATE Professor SET nome = :nome, cpf = :cpf, idade = :idade, nascimento = :nascimento, endereco = :endereco WHERE id = :id");
...
<div class="box">
    <h1>Alterar Professor</h1>
      <form method="post">
            ...
            <p>Data de Nascimento: <br> <input type="date" placeholder="Digite sua data de nascimento" name="nascimento" required value="<?php echo $professor['nascimento']; ?>" ></p>
