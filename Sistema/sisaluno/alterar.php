...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $stmt = $conexao->prepare("UPDATE Aluno SET nome = :nome, idade = :idade, nascimento = :nascimento, endereco = :endereco, estatus = :estatus WHERE id = :id");
...
<div class="box">
    <h1>Alterar Aluno</h1>
      <form method="post">
            ...
            <p>Data de Nascimento: <br> <input type="date" placeholder="Digite sua data de nascimento" name="nascimento" required value="<?php echo $aluno['nascimento']; ?>" ></p>
