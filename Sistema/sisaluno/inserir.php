...
<body>
    <div class="box">
        ...
        <form method="post" action="inserir.php">
            ...
            <p>Data de Nascimento: <br> <input type="date" placeholder="Digite sua data de nascimento" name="nascimento" required></p>
...
if (isset($_POST['nome'])) {
    ...
    $stmt = $conexao->prepare("INSERT INTO Aluno (nome, idade, nascimento, endereco, estatus) VALUES (:nome, :idade, :nascimento, :endereco, :estatus)");
